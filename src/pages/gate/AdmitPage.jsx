        ...
        <div className="fade-up">
          ...
          {type === 'vehicle' && (
            <>
              ...
              {!ocrResult && (
                <div style={{ background: 'var(--bg-3)', borderRadius: 'var(--radius-lg)', overflow: 'hidden', marginBottom: '14px', minHeight: '160px', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative' }}>
                  {cameraOpen
                    ? <>
