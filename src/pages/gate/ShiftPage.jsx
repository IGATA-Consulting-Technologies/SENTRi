...
export default function ShiftPage({ gateData, tenantData }) {
    ...
    <div className="page-content-padded fade-up">
      ...
      {insideCount > 0 && (
        <div className="alert alert-warn">
          ...
          <strong>{insideCount} vehicle{insideCount !== 1 ? 's' : ''}</strong> currently inside — this will be recorded in the handover log.
        </div>
      )}
  ...
  return (
    <div className="page-content-padded fade-up">
      ...
      <p style={{ fontSize: '13px', color: 'var(--text-2)', textAlign: 'center', marginBottom: '12px' }}>Going off duty? Hand over to the incoming guard.</p>
      <button className="btn btn-danger btn-full" onClick={() => setHandoverStep(1)}>
